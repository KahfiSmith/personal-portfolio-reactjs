        ...
        <div className="w-full md:flex md:flex-col items-start justify-start px-4 max-w-5xl">
          ...
          <div className="text-justify mb-6">
            ...
            <p className="mb-6 text-sm md:text-base leading-6 md:leading-7">
              ...
              school students. Offering interactive study materials, quizzes,
              and in-depth learning videos, EduVerse helps students understand
              concepts in a fun and effective way. With virtual classroom
              features and adaptive learning, Eduverse is the perfect study
              companion for preparing for exams and increasing knowledge in
            ...
            <ul className="text-sm space-y-6 list-disc list-inside">
              ...
              <li className="font-medium text-lg">
                ...
                <span className="block font-normal text-sm md:text-[14px] leading-6 md:leading-7 ml-6 mb-4">
                  ...
                  high school students. The materials are designed to be
                  engaging and easy to understand, covering a wide range of
                  subjects to support their academic needs.
                </span>
                <div>
                  <ImageLazy
                    src="/images/eduverse-2.png"
                    alt="eduverse-2"
                    className="rounded-lg"
                  />
                </div>
              ...
              <li className="font-medium text-lg">
                ...
                <span className="block font-normal text-sm md:text-[14px] leading-6 md:leading-7 ml-6 mb-4">
                  ...
                  understanding of various topics. The quizzes are designed to
                  be fun and engaging while providing immediate feedback to
                  enhance learning.
                </span>
                <div>
                  <ImageLazy
                    src="/images/eduverse-3.png"
                    alt="eduverse-3"
                    className="rounded-lg"
                  />
                </div>
              ...
              <li className="font-medium text-lg">
                ...
                <span className="block font-normal text-sm md:text-[14px] leading-6 md:leading-7 ml-6 mb-4">
                  ...
                  detailed explanations, examples, and exercises to help
                  students master the material.
                </span>
                <div>
                  <ImageLazy
                    src="/images/eduverse-4.png"
                    alt="eduverse-4"
                    className="rounded-lg"
                  />
                </div>
              ...
              <li className="font-medium text-lg">
                ...
                <span className="block font-normal text-sm md:text-[14px] leading-6 md:leading-7 ml-6 mb-4">
                  ...
                  questions, share ideas, and engage in meaningful discussions
                  to deepen their understanding.
                </span>
                <div>
                  <ImageLazy
                    src="/images/eduverse-5.png"
                    alt="eduverse-5"
                    className="rounded-lg"
                  />
                </div>
              ...
              <li className="font-medium text-lg">
                Rewards
                <span className="block font-normal text-sm md:text-[14px] leading-6 md:leading-7 ml-6 mb-4">
                  The rewards system allows students to earn points based on
                  their learning activities, such as completing materials,
                  taking quizzes, or participating in discussions. These points
                  can be redeemed for exciting rewards, including vouchers,
                  exclusive access to premium content, or educational
                  merchandise. This feature is designed to motivate students to
                  stay active and consistent in their learning journey.
                </span>
                <div>
                  <ImageLazy
                    src="/images/eduverse-6.png"
                    alt="eduverse-6"
                    className="rounded-lg"
                  />
                </div>
