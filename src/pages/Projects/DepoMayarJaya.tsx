      ...
      <div className="w-full md:flex md:flex-col items-start justify-start px-4 max-w-5xl">
        ...
        <div className="text-justify mb-6">
          ...
          <p className="mb-6 text-sm md:text-base leading-6 md:leading-7">
            Welcome to Depo Mayar Jaya a comprehensive web platform specifically
            designed to facilitate the management of sales and distribution of
            products such as gallons of water and LPG. With this website you can
            optimize your business operations from one integrated dashboard,
            enabling stock, customer and sales management to be more efficient
            and effective.
          </p>
          <h2 className="mb-3 font-medium text-lg md:text-xl lg:text-2xl">
          ...
          <ul className="text-sm space-y-6 list-disc list-inside">
            <li className="font-medium text-lg">
              ...
              <span className="block font-normal text-sm md:text-[14px] leading-6 md:leading-7 ml-6 mb-4">
                The dashboard is a control center where you can see various key
                performance metrics, including revenue per day, per month, per
                year, as well as total income during operating time. This
            ...
            <li className="font-medium text-lg">
              History
              <span className="block font-normal text-sm md:text-[14px] leading-6 md:leading-7 ml-6 mb-4">
                The history section presents a complete list of all transactions
                that have been carried out. Every transaction is recorded with
                details including date, amount and items purchased. This feature
                is also equipped with the ability to filter transaction history
                results based on various criteria such as date, customer, or
                amount, which makes it easier to search for specific
                transactions. In addition, there is an option to print
                transactions which makes it easier to create physical reports or
