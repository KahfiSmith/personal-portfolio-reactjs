      ...
      <div className="w-full md:flex md:flex-col items-start justify-start px-4 max-w-5xl">
        ...
        <div className="text-justify mb-6">
          ...
          <p className="mb-6 text-sm md:text-base leading-6 md:leading-7">
            ...
            specifically designed to help and simplify the process of reporting
            and managing PKK (Family Empowerment and Welfare) data in Nganjuk
            Regency. The platform provides efficient solutions for data
            collection, analysis and reporting, ensuring all information related
            to the PKK program can be easily accessed by various stakeholders.
          </p>
          <h2 className="mb-3 font-medium text-lg md:text-xl lg:text-2xl">
          ...
          <ul className="text-sm space-y-6 list-disc list-inside">
            <li className="font-medium text-lg">
              ...
              <span className="block font-normal text-sm md:text-[14px] leading-6 md:leading-7 ml-6 mb-4">
                ...
                activities. Its intuitive design allows users to get up-to-date
                and relevant information quickly and easily.
              </span>
              <div>
                <ImageLazy
                  src="/images/pkk-1.png"
            ...
            <li className="font-medium text-lg">
              ...
              <span className="block font-normal text-sm md:text-[14px] leading-6 md:leading-7 ml-6 mb-4">
                ...
                number of active users in the system. This helps admins monitor
                activity on the website and measure participation in PKK
                programs. This dashboard is equipped with various analytical
                tools that help in making strategic decisions based on data.
              </span>
              <div>
                <ImageLazy
            ...
            <li className="font-medium text-lg">
              ...
              <span className="block font-normal text-sm md:text-[14px] leading-6 md:leading-7 ml-6 mb-4">
                ...
                post, edit and delete news as needed. This provides an important
                means of keeping members and the general public informed about
                the PKK's activities and achievements.
              </span>
              <div>
                <ImageLazy
            ...
            <li className="font-medium text-lg">
              ...
              <span className="block font-normal text-sm md:text-[14px] leading-6 md:leading-7 ml-6 mb-4">
                ...
                accessed by users not only through the website but also through
                the application on their mobile devices. This includes
            ...
            <li className="font-medium text-lg">
              ...
              <span className="block font-normal text-sm md:text-[14px] leading-6 md:leading-7 ml-6 mb-4">
                ...
                managing these images, including approving, editing, or deleting
                inappropriate images before they appear on the homepage. This
                gallery aims to visualize the PKK's activities and achievements,
                providing visual evidence of the positive impact of their
                activities.
              </span>
              <div>
                <ImageLazy
