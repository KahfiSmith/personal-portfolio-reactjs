      ...
      <div className="w-full md:flex md:flex-col items-start justify-start px-4 max-w-5xl">
        ...
        <div className="text-justify mb-6">
          ...
          <p className="mb-6 text-sm md:text-base leading-6 md:leading-7">
            ...
            to explore stunning anime works without any hassle and clutter. At
            ReviewNime we believe that beauty lies in simplicity. That's why our
            designs prioritize clarity and ease of navigation. With an elegant
            color palette and minimalist layout, users can easily browse the
            list of anime films, from classics to the latest releases, all
            neatly arranged in a clean and organized interface.
          </p>
          <h2 className="mb-3 font-medium text-lg md:text-xl lg:text-2xl">
          ...
          <ul className="text-sm space-y-6 list-disc list-inside">
            <li className="font-medium text-lg">
              ...
              <span className="block font-normal mt-1 text-sm md:text-base leading-6 md:leading-7 ml-6 mb-4">
                ...
                viewers with the latest updates and specially curated editorial
            ...
            <li className="font-medium text-lg">
              ...
              <span className="block font-normal mt-1 text-sm md:text-base leading-6 md:leading-7 ml-6 mb-4">
                ...
                or popularity rating. Each entry in this list is organized in an
                easy-to-navigate format, allowing users to intuitively find
            ...
            <li className="font-medium text-lg">
              ...
              <span className="block font-normal mt-1 text-sm md:text-base leading-6 md:leading-7 ml-6 mb-4">
                ...
                descriptions is to give users enough insight so they can decide
                whether the anime is what they are looking for, while
            ...
            <li className="font-medium text-lg">
              ...
              <span className="block font-normal mt-1 text-sm md:text-base leading-6 md:leading-7 ml-6 mb-4">
                ...
                the story, and relationship dynamics with other characters. This
                feature is especially useful for fans who want to get a complete
                picture of a character's personality and evolution throughout
                the series.
              </span>
              <div>
                <img
