    ...
    <Motion>
      ...
      <div className="w-full flex justify-center min-h-screen items-start pt-10">
        <div className="w-full md:flex md:flex-col items-start justify-start px-4 max-w-5xl">
          <BackButton
            title="ReLive - Online mental health consultation platform"
          ...
          <div className="text-justify mb-6">
            ...
            <p className="mb-6 text-sm md:text-[14px] leading-6 md:leading-7">
              ...
              consultation history, as well as discussion forums or communities
              to share experiences and get support from fellow users. The
              platform is built with modern technologies such as React, Node,
              and Express, ensuring an intuitive and responsive user experience.
            </p>
            <h2 className="mb-3 font-medium text-lg md:text-xl lg:text-2xl">
            ...
            <ul className="text-sm space-y-6 list-disc list-inside">
              <li className="font-medium text-lg">
                ...
                <span className="block font-normal text-sm md:text-[14px] leading-6 md:leading-7 ml-6 mb-4">
                  Users can choose from a list of available psychologists based
                  on their specialization, experience and reviews of other
                  users. This feature allows users to find the psychologist who
              ...
              <li className="font-medium text-lg">
                ...
                <span className="block font-normal text-sm md:text-[14px] leading-6 md:leading-7 ml-6 mb-4">
                  ...
                  with the psychologist they choose via WhatsApp. Users can
                  start a chat on the ReLive website, who will then be directed
                  to the WhatsApp application to continue the discussion and get
                  direct psychological assistance.
                </span>
              </li>
              <li className="font-medium text-lg">
                History
                <span className="block font-normal text-sm md:text-[14px] leading-6 md:leading-7 ml-6 mb-4">
                  This feature keeps complete records of all consultation
                  sessions carried out by the user. Users can look back at their
