...
export function AboutCard() {
  ...
  return (
    <>
        ...
        {active && typeof active === "object" ? (
          <div className="fixed inset-0 grid place-items-center z-[100]">
            <motion.button
              ...
              className="flex absolute top-2 right-2 lg:hidden items-center justify-center bg-customSoft rounded-full h-6 w-6"
            ...
            <motion.div
              ...
              ref={ref}
              className="w-full max-w-[500px] h-full md:h-fit md:max-h-[90%] flex flex-col bg-customBackground sm:rounded-xl overflow-hidden"
            >
                ...
                <div className="flex justify-between items-start p-4">
                  <div>
                    <motion.h3
                      ...
                      className="font-semibold text-customText"
                    >
                      {active.title}
                    </motion.h3>
                    <motion.p
      ...
      <ul className="mx-auto w-full gap-4 mb-4">
        {cards.map((card) => (
          <motion.div
          ...
          >
            ...
            <motion.button
              ...
              className="px-4 py-2 text-sm rounded-full font-semibold bg-customSoft hover:bg-customVerySoft hover:text-white mt-4 md:mt-0"
            >
              {card.ctaText}
            </motion.button>
          </motion.div>
...
export const CloseIcon = () => {
  return (
    <motion.svg
      ...
      className="h-4 w-4 text-customText"
    >
