  ...
  return (
    <div className="relative rounded-lg mx-auto shadow-md overflow-hidden group">
      <img
        src={imgSrc}
        alt={title}
        className="w-full object-cover transition-transform duration-500 ease-in-out group-hover:scale-150"
      />
      <div className="absolute inset-0 bg-black/50 hover:bg-black/20 flex flex-col justify-between ">
        <div className="bg-transparent backdrop-blur-sm p-3 rounded-t-lg">
